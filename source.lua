--official FedsHub source, by federal | skillzYT 


local Rayfield = loadstring(game:HttpGet("https://raw.githubusercontent.com/fedoradevs/FedsHub/refs/heads/main/GUI.lua"))()

local Window = Rayfield:CreateWindow({
    Name = "FedsHub | FlingThingsAndPeople",
    Icon = 0,
    LoadingTitle = "Valid Key! Loading..",
   ...
   KeySettings = {
      Title = "Key | FedsHub",
      Subtitle = "Key system, by federal",
      Note = "Private key system, please get a key from federal or skillz.", 
      FileName = "FederalHubKey", 
      SaveKey = false, 
      GrabKeyFromSite = false, 
      Key = {"feds-28F9$#@KJHsdf8324@!"} 
   }
